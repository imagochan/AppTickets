...
class PantallaCrearOActualizarCategorias extends StatefulWidget {
  ...
  @override
  State<PantallaCrearOActualizarCategorias> createState() =>
      _PantallaCrearOActualizarCategoriasState();
}

class _PantallaCrearOActualizarCategoriasState
    extends State<PantallaCrearOActualizarCategorias> {
  //String categoriaID='';
  ...
  void submitCategory() {
    ...
    if (widget.esCrearOActualizar) {
      ...
      if (_formKey.currentState!.validate()) {
        var unaCategoria = {"categoriaNombre": categoriaController.text};
      ...
      ApiCategorias.actualizarCategoria(
          widget.unaCategoria.id, {"categoria": categoriaController.text});
